        ...
        <div className="relative">
          ...
          >
            {stories.map((story) => (
              <article
                key={story.id}
                className="snap-start flex-shrink-0 w-full md:w-1/2 lg:w-1/3 bg-[#f8f8f8] text-gray-900 rounded-xl overflow-hidden shadow-lg hover:shadow-2xl transition-shadow duration-300"
              >
                {/* Image */}
