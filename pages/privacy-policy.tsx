...
const PrivacyPolicy = () => {
    return (
        <div className="page-bg min-h-screen">
            <Meta
                title="Privacy Policy | Gramika News"
                description="Privacy Policy for Gramika - Learn how we collect, use, and protect your data."
                url="https://www.gramika.in/privacy-policy"
            />
            <Header />
            ...
            <main className="page-container py-12 sm:py-16">
                <article className="surface-elevated p-8 sm:p-10 legal-content max-w-4xl mx-auto">
                    ...
                    <section className="space-y-6">
                        ...
                        <p>
                            Email: <a href="mailto:newsgramika@gmail.com">newsgramika@gmail.com</a>
                        </p>
                    </section>
                </article>
            </main>
