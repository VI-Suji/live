...
import AdminAuthGuard, { useAdminAccess } from "../../components/AdminAuthGuard";
import {
    FaNewspaper,
    FaMapMarkerAlt,
    FaBell,
...
const contentTypes = [
    ...
    },
    {
        ...
        description: "Manage video links",
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3 sm:py-4">
                    <div className="flex items-center justify-between gap-4">
                        ...
                        <div className="flex items-center gap-2 sm:gap-4">
                            ...
                            <button
                                onClick={() => {
                                    localStorage.removeItem("gramika_admin_access"); // Clear secondary auth
                                    signOut({ callbackUrl: "/" });
                                }}
